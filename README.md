...
<div align="center">
  ...
  <p>💻 A atividade é composta por <strong>5 desafios</strong>, envolvendo condicionais, operadores lógicos, estruturas de repetição, arrays e funções.</p>
</div>
...
<div align="center">
  ...
  <p>🛒 Sistema que calcula o preço de um produto aplicando <strong>10% de desconto</strong> para compras a partir de <strong>R$ 200,00</strong>.</p>

  <p><strong>🔹 <a href="https://github.com/Pedro-h1/ATV_LISTA1-BACKEND/blob/main/exerc/2_aprovacao.php">2. Verificação de aprovação</a></strong></p>
  <p>📊 Sistema que verifica se um aluno foi aprovado considerando uma <strong>média maior ou igual a 6,0</strong> e um <strong>limite de faltas menor ou igual a 15</strong>, utilizando o operador lógico <code>&&</code>.</p>

  <p><strong>🔹 <a href="https://github.com/Pedro-h1/ATV_LISTA1-BACKEND/blob/main/exerc/3_tabuada.php">3. Tabuada</a></strong></p>
  <p>🔢 Criação de uma tabuada de <strong>1 a 10</strong> para um número específico utilizando a estrutura de repetição <code>for</code>.</p>

  <p><strong>🔹 <a href="https://github.com/Pedro-h1/ATV_LISTA1-BACKEND/blob/main/exerc/4_notas.php">4. Processamento de notas</a></strong></p>
  <p>📝 Processamento de um <strong>array com 5 notas</strong>, realizando o cálculo da média e identificando a maior e a menor nota.</p>

  <p><strong>🔹 <a href="https://github.com/Pedro-h1/ATV_LISTA1-BACKEND/blob/main/exerc/5_imc.php">5. Cálculo de IMC</a></strong></p>
  <p>⚖️ Criação da função <code>calcularIMC($peso, $altura)</code> para calcular o IMC e classificar o resultado em:</p>
  <p>🟡 Abaixo do peso &nbsp;|&nbsp; 🟢 Peso normal &nbsp;|&nbsp; 🟠 Sobrepeso &nbsp;|&nbsp; 🔴 Obesidade</p>
</div>
